...
//select c.Nm,h.TrnCtrlNo,h.DocNoPrefix,h.DocDt,s.DocQty,s.DocEntRate,s.DocEntNetValue from StkTrnHdr h join StkTrnDtls s on h.TrnType = s.TrnType and h.TrnCtrlNo = s.TrnCtrlNo and h.DocNoPrefix = s.DocNoPrefix and h.DocNo = s.DocNo join Customers c on h.PartyId = c.Code where s.StockNo = '".$_REQUEST['StockNo']."' and h.TrnType='1200'
...
$sql.=" FROM StkTrnHdr h join StkTrnDtls s on h.TrnType = s.TrnType and h.TrnCtrlNo = s.TrnCtrlNo and h.DocNoPrefix = s.DocNoPrefix and h.DocNo = s.DocNo join Customers c on h.PartyId = c.Code where s.StockNo = '".$_REQUEST['StockNo']."' and h.TrnType='1200'";
